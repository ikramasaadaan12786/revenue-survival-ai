...
export const MissionWarRoom: React.FC<MissionWarRoomProps> = ({
  ...
  const [priorityQueue, setPriorityQueue] = useState<PriorityLead[]>([
    {
      ...
      company: 'Prime Capital Dubai',
      source: 'RADAR (BUYER DISCUSSIONS)',
      industry: 'AI Automation & PropTech',
      offer: 'B2B Autonomous Outbound Engine',
      expected_revenue: 50000,
      closing_probability_percent: 85.0,
      weighted_revenue: 42500,
      recommended_action: 'Authorize initial outreach sequence via WhatsApp to present B2B Autonomous Outbound Engine',
      classification: 'HOT BUYER',
    },
    {
      lead_id: 236,
      name: 'Stefan Zimmermann',
      company: 'Zimmermann Wealth Advisors',
      source: 'REDDIT (UAE BUSINESS)',
      industry: 'Dubai Real Estate & Advisory',
      offer: 'B2B Autonomous Outbound Engine',
      expected_revenue: 7800000,
      closing_probability_percent: 65.0,
      weighted_revenue: 5070000,
      recommended_action: 'Authorize initial outreach sequence via Email to present B2B Outbound Engine',
      classification: 'QUALIFIED BUYER',
    },
    {
      lead_id: 230,
      name: 'Tariq Mansoor',
      company: 'Mansoor Tech Holdings',
      source: 'TELEGRAM (DUBAI TECH)',
      industry: 'AI Agents & Automation',
      offer: 'B2B Autonomous Outbound Engine',
      expected_revenue: 1450000,
      closing_probability_percent: 65.0,
      weighted_revenue: 942500,
      recommended_action: 'Approve Telegram proposal briefing for Tariq Mansoor',
      classification: 'QUALIFIED BUYER',
    },
    {
      lead_id: 232,
      name: 'Faisal Bin Laden',
      company: 'Bin Laden Commercial',
      source: 'LINKEDIN',
      industry: 'Enterprise Software',
      offer: 'B2B Autonomous Outbound Engine',
      expected_revenue: 38000,
      closing_probability_percent: 65.0,
      weighted_revenue: 24700,
      recommended_action: 'Approve LinkedIn direct executive message for Faisal Bin Laden',
      classification: 'QUALIFIED BUYER',
    },
    {
      lead_id: 238,
      name: 'Rajesh Singhania',
      company: 'Singhania Global Real Estate',
      source: 'YOUTUBE SIGNALS',
      industry: 'Dubai Real Estate & Advisory',
      offer: 'B2B Autonomous Outbound Engine',
      expected_revenue: 12000000,
      closing_probability_percent: 65.0,
      weighted_revenue: 7800000,
      recommended_action: 'Authorize initial outreach sequence via Email to present B2B Outbound Engine',
      classification: 'QUALIFIED BUYER',
    },
  ]);
  ...
  const [sprintData, setSprintData] = useState<SprintData>({
    ...
    revenue_gap_aed: 2500,
    remaining_hours: 15.8,
    required_velocity_aed_hr: 158.2,
    fastest_closing_opportunity: {
      name: 'Rashid Al-Maktoum / Prime Capital Family Office',
      offer: 'B2B Autonomous Outbound Engine',
      expected_revenue: 50000,
    ...
    fastest_offer: {
      ...
      reason: '100% covers remaining AED 2,500 target with a single rapid close.',
    },
    fastest_channel: {
    ...
    tactical_closing_plan: [
      'Step 1: Approve top priority LinkedIn message for Rashid Al-Maktoum in Safety Gate.',
      'Step 2: Dispatch AI Customer Support Copilot proposal priced at 2,500 AED.',
      'Step 3: Secure settlement to instantly surpass the AED 2,500 sprint target.',
    ],
  });
  ...
  const [targetPlan, setTargetPlan] = useState<TargetPlanData>({
    quotas: {
      ...
      messages_needed: 8,
      offers_needed: 2,
      expected_conversion_percent: 50.0,
    },
    executive_directives: [
      'Authorize 5 high-priority outreach sequences in the Safety Approval Queue.',
      'Schedule 3 rapid 15-minute executive discovery sessions with warm respondents.',
      'Deliver 2 pre-structured tailored proposals (AI Customer Support Copilot or B2B Engine).',
      'Maintain an execution velocity of 158.20 AED/hour over the remaining 15.8 hours.',
    ],
    strategy_summary: 'Target of 2,500 AED achievable with 1 high-ticket close from 2 staged proposals across 15.8 hours.',
  });
